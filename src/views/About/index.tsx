...
const AboutView: FC = () => {
    return (
        <div className='h-[calc(100vh-theme(spacing.16))] mt-0 mb-16 md:mb-0 md:mt-16 text-neutral-100 p-4 flex items-center justify-center gap-10 flex-col'>
            ...
            <div className='flex flex-col max-w-md gap-2 text-sm text-center text-neutral-500'>
                <p>
