    ...
    return (
        <m.div onClick={handleNavgationItemClick} className={
            cn("relative flex items-center justify-center h-16 gap-2 px-4 cursor-pointer md:px-10 transition-all duration-300 select-none",
                active ? "text-tulip-tree-400" : "text-neutral-400 hover:text-tulip-tree-300"
            )
        }>
            {
                active && (
            ...
            {
                newFeature && (
                    <span className="px-1 py-1 mb-2 text-xs font-bold rounded-full shadow-md animate-pulse md:py-0 text-neutral-950 bg-tulip-tree-300 shadow-tulip-tree-400/40">
